...
function maison_calista_copyright_year(): string {
	return esc_html( gmdate( 'Y', current_time( 'timestamp' ) ) );
}
 ...
 */
function maison_calista_whatsapp_button( array $atts = array() ): string {
	$atts = shortcode_atts(
		array(
	...
	if ( '' === $number ) {
		...
		$hint  = $is_en
			...
			: "D\u{00E9}finir le num\u{00E9}ro dans Apparence \u{2192} Personnaliser \u{2192} Maison Calista Settings.";
		return sprintf(
...
function maison_calista_location_label_shortcode(): string {
	...
	$label = $is_en
		...
		: (string) get_theme_mod( 'maison_calista_location_label', "Pr\u{00E8}s de Marrakech, Maroc" );
...
function maison_calista_maps_shortcode(): string {
	...
	if ( $embed ) {
		$title = $is_en
			...
			: "Carte de Maison Calista pr\u{00E8}s de Marrakech";
		$html  = sprintf(
	...
	$title = $is_en ? 'Map placeholder — exact pin to be confirmed' : "Carte d\u{00E9}sactiv\u{00E9}e \u{2014} emplacement exact \u{00E0} confirmer";
	$body  = $is_en
		...
		: "La carte interactive appara\u{00EEtra ici d\u{00E8}s que l\u{2019}URL d\u{2019}int\u{00E9}gration Google Maps sera ajout\u{00E9}e dans Apparence \u{2192} Personnaliser \u{2192} Maison Calista Settings.";
...
function maison_calista_legal_review_notice_shortcode(): string {
	...
	$msg   = $is_en
		...
		: (string) get_theme_mod(
			...
			"\u{00C0} R\u{00C9}VISER AVANT LA MISE EN LIGNE \u{2014} Cette page est un mod\u{00E8}le professionnel \u{00E0} titre informatif uniquement. Elle doit \u{00EA}tre contr\u{00F4}l\u{00E9}e et valid\u{00E9}e par un juriste qualifi\u{00E9} avant publication."
		);
 ...
 */
function maison_calista_site_logo_shortcode( array $atts = array() ): string {
	$atts = shortcode_atts(
		array(
			'class'  => 'mc-site-logo',
			'width'  => '160',
