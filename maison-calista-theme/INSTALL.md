...
3. Kies `maison-calista-theme-1.3.4.zip`.
4. Klik **Nu installeren**, daarna **Activeren**.
5. Pagina’s, menu’s en homepage worden automatisch aangemaakt. Open daarna één keer **Weergave → Thema’s** of **Pagina’s** — als setup nog ontbrak (bijv. na herupload van hetzelfde thema), herstelt het thema zichzelf.
