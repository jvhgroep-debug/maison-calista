...
function maison_calista_customize_register( WP_Customize_Manager $wp_customize ): void {
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => "À RÉVISER AVANT LA MISE EN LIGNE — Cette page est un modèle professionnel à titre informatif uniquement. Elle doit être contrôlée et validée par un juriste qualifié avant publication.",
